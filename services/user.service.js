...
async function create(req,result){
   // console.log(req.body);
    let user = {Id: uuidv1(),FullName : req.body.FullName,IsActive : 1, PasswordHash : bcrypt.hashSync(req.body.Password, 10),AccessFailedCount: 0,EmailId:req.body.EmailId,RoleId:req.body.RoleId}
